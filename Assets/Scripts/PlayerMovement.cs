...
public class PlayerMovement : MonoBehaviour
{
    ...
    public struct Stats
    {
        ...
        public bool canJump;
        [Tooltip("When the player is stomping an enemy this will be false")]
        public bool canHurt;//add health here
    ...
    private void Start()
    {
        ...
        HealthManager.ResetHealth(playerStats.startingHealth);
    }
